...
This export embeds Framer's actual runtime (`react`, `motion`, `framer`, 137 chunks total, 29843 KB) so the page renders byte-for-byte identical to your live Framer site.

> Generated for **blushing-motivation-601543.framer.app** on 2026-08-10.
