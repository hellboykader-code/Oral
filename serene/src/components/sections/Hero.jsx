    ...
    <section className="hero">
      ...
      <div className="container hero__inner">
        <div className="hero__content">
          ...
          >
            Des soins précis et attentionnés, dans un cadre apaisant pensé pour
            votre confort. Prenez rendez-vous en toute sérénité.
          </motion.p>
          <motion.div
        ...
        >
          <span className="hero__badge-icon" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              <path d="M12 2 4 5v6c0 5 3.4 8.3 8 11 4.6-2.7 8-6 8-11V5l-8-3Z" fill="#963f36" />
              <path d="m9 12 2 2 4-4" stroke="#dbf6e9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
          <div>
